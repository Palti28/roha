---
title: "Roha Shop: UI Design in Figma"
summary: "Designing the storefront for Roha's own products: a small shop that had to feel considered without feeling busy."
category: "uiux"
service: "UI Design + Design System"
duration: "2 weeks"
year: 2026
client: "Roha"
concept: false
...
Roha sells a small, deliberate catalogue: template kits, icon sets, Notion systems. The shop needed an interface that matched the studio's own voice: quiet, precise, considered. That meant resisting the usual e-commerce reflexes (no urgency banners, no carousel, no twelve-product grid) and designing something closer to a well-kept shelf than a marketplace.
...
> *"A small studio can't afford a design file that only its author can navigate."*
...
For a studio that deliberately keeps a small number of projects in flight, that reuse isn't a nice-to-have, it's how the math works.
